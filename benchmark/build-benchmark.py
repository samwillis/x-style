...
def build(max=False):
    ...
    with open(f'{name}-benchmark-styles.html', 'w') as f:
        f.write(benchmark_styles)

    with open(f'{name}-benchmark-x-styles.html', 'w') as f:
        f.write(benchmark_x_styles)

    with open(f'{name}-benchmark-x-styles-no-mutate.html', 'w') as f:
        f.write(benchmark_x_styles_no_mutate)

    with open(f'{name}-benchmark-classes.html', 'w') as f:
